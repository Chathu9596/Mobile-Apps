...
//Message
const msgtxt1 = '<p class = "image"><img src = "img/wd.jpg" width=61px height=61px></p><p class="text">White Die Attack!(your turn)</p>';
const msgtxt2 = '<p class = "image"><img src = "img/bd.jpg" width=61px height=61px></p><p class="text ">Black Die Attack!(computer turn)</p>';
const msgtxt3 = '<p class = "image"><img src = "img/wd.jpg" width=61px height=61px></p><p class="text animate__animated animate__fadeInBottomLeft">White Die Win!!</p>';
const msgtxt4 = '<p class = "image"><img src = "img/bd.jpg" width=61px height=61px></p><p class="text animate__animated animate__fadeInBottomRight">Black Die Win!!</p>';
const msgtxt5 = '<p class = "image"><img src = "img/wd.jpg" width=61px height=61px><img src ="img/bd.jpg" width=61px height=61px</p><p class="text animate__bounceIn">Draw!!</p>';
